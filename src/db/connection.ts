...
function runEventsMigrations(db: Database.Database, fromVersion: number): void {
  ...
  // Migration 7 → 8: Add ui_events table (Phase 6.2)
  if (fromVersion < 8) {
    try {
      db.exec('BEGIN TRANSACTION');
